...
void exportGridCalibration() {
  ...
  // POINTCLOUD
  class_<GridCalibrationTargetPointCloud::PointCloudOptions>("PointCloudOptions", init<>())
    .def_pickle(sm::python::pickle_suite<GridCalibrationTargetPointCloud::PointCloudOptions>());

  class_<GridCalibrationTargetPointCloud, bases<GridCalibrationTargetBase>,
      boost::shared_ptr<GridCalibrationTargetPointCloud>, boost::noncopyable>(
      "GridCalibrationTargetPointCloud", init<const Eigen::MatrixXd &, GridCalibrationTargetPointCloud::PointCloudOptions>(
          "GridCalibrationTargetPointCloud(const Eigen::MatrixXd &pointsMat, PointCloudOptions options)"))
      .def(init<const Eigen::MatrixXd &>("GridCalibrationTargetPointCloud(const Eigen::MatrixXd &pointsMat)"))
      .def(init<>("Do not use the default constructor. It is only necessary for the pickle interface"))
      .def_pickle(sm::python::pickle_suite<GridCalibrationTargetPointCloud>());
  // END POINTCLOUD
