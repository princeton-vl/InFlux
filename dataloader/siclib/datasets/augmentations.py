...
class InFluxSynthAugmentations(BaseAugmentation):
    default_conf = {"p": 1.0}
...
class RevisitingAugmentations(BaseAugmentation):
    """Augmentations as defined in revisit/code/calib/data_loader/generic_loader.py"""
...
augmentations = {
    ...
    "revisiting": RevisitingAugmentations,
    "influx_synth": InFluxSynthAugmentations,
}
